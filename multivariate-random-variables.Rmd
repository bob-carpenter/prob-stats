...
Antoine Gombaud, the Chevalier de Méré, challenged Blaise Pascal and
Pierre de Fermat to calculate the probability of at least one
double-six occuring in 24 fair throws of a pair of six-sided dice. We
can evaluate this by simulation directly.^[Working out the example
analytically, there is a $\frac{35}{36}$ chance of *not* throwing
double six with two six-sided dice, and so $\left( \frac{35}{36}
\right)^{24}$ is the probability of *not* throwing at least one double
six in 24 throws, and so $$1 - \left( \frac{35}{36} \right)^{24}
\approx 0.491$$ is the probability of throwing at least one double-six
in 24 fair throws of a pair of six-sided dice.]
