...
under the density plot. The probability of a draw from rejection
...
Many sampling methods use auxiliary variables.  The rejection sampling
algorithm written out for our particular case is as follows.
...
draws come from a specified distribution. For now, we perform
"$\\chi$-by-eye."]
