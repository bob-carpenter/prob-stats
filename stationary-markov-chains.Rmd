...
stationary distribution.^[ If a discrete Markov chain is reversible with
respect to $\pi$, then $\pi$ is also the unique stationary
distribution of the Markov chain. Markov chains can have stationary
distributions without being reversible.^[The reducible chains we saw
earlier are examples with stationary distributions that are not
