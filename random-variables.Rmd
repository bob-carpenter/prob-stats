...
```{r echo=FALSE, out.width="80%", fig.cap="Monte Carlo estimate of
probability that a coin lands head as a function of the number of
simulation draws.  The line at 0.5 marks the true probability being estimated."}
set.seed(0)
library(ggplot2)
M <- 1e5
Ms <- c()
...
draws, the linear relationhip plotted in the figures have the
form
...
error $\epsilon_M$ after $M$ simulation draws may be succintly
