...
```{r fig.cap="Absolute error versus number of simulation draws for 100 simulated sequences of $M = 1\\,000\\,000$ draws. The blue line is at the 68% quantile and the red line at the 95% quantile of these draws.  The relationship between the log number of draws and log error is revealed to be linear."}
