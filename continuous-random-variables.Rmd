...
Now let's plot what we get out to $1\,000$ dimensions or so and see
what those distances to the center of the .
...
It seems intuitively that draws should be uniformly dispersed, they in
fact do two things that are quite surprising based on our intuitions
in low dimensions,
...
printf('min = %5.1f;  mean = %5.1f;  max = %5.1f\n',
       min(d), mean(d), max(d))
```

We see that the average distances between points is even greater than
