...
We have already seen that if we take a uniformaly distributed variable,
$$
...
normal by multiplying it by a scale parameter, it is convential to
...
Similarly, the trasnformed version also has a standard deviation of $1
