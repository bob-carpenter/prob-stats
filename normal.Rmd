...
\mathbb{E}[Y]}{\mathrm{sd}[Y]}.$$ and used to standardize any random
...
p_Z(z) = \mbox{normal}(),
$$
from whcih the Jacobian calculation gives us
$$
\begin{array}{rcl}
p_Y(y)
& = &
...
scale,^[This factor derives from the change-of-variables adjustment in
the location-scale transform, whose inverse is $f^{-1}(y) = \frac{y -
\mu}{\sigma}$.]
