...
H[U] \geq H[V],
$$
with equality only if $V$ is also normally distributed,
$V \sim \textrm{normal}(\mu, \sigma).$

Another way of saying this is that among all possible random variables
with a given expectation and standard deviation, a normally
distributed one has the maximum entropy.
