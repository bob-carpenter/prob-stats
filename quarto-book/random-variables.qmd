...
```{python}
#| code-fold: true
model_dnd = CmdStanModel(stan_file = "dnd-attributes.stan")
...
* *Exercise*:  The advantage and disadvantage system in *D & D* involves
...
```{python}
#| code-fold: true
model_diff = CmdStanModel(stan_file = "dnd-diff.stan")
